...
> **Website & docs:** a static landing page and documentation site live in [`site/`](site/) (vanilla HTML/CSS/JS, no build step — open `site/index.html`, or host the folder with GitHub Pages).
